...
class TestSmokeTest():
  ...
  def test_test1LogoHeaderandTitle(self):
    self.driver.get("https://erikfenriz.github.io/cse270-teton/index.html")
  ...
  def test_test2HomePage(self):
    ...
    self.vars["https://erikfenriz.github.io/cse270-teton/join.html"] = self.driver.execute_script("return window.location.href")
  
  def test_test3DirectoryGridandListfeature(self):
    self.driver.get("https://erikfenriz.github.io/cse270-teton/directory.html")
  ...
  def test_test4JoinPageDataEntry(self):
    self.driver.get("https://erikfenriz.github.io/cse270-teton/join.html")
  ...
  def test_test5AdminPageUsernamePassword(self):
    self.driver.get("https://erikfenriz.github.io/cse270-teton/admin.html")
